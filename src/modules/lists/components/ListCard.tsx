      ...
      <div className="flex items-center gap-3">
        {showPrimaryToggle && (
          <button
            ...
            className={`active:opacity-60 disabled:opacity-50 ${isPrimary ? "text-foreground" : "text-foreground/40 hover:text-foreground"}`}
          >
            {isPrimary ? (
        ...
        {dragHandleProps && (
          <button
            ...
            className="touch-none cursor-grab select-none px-2 text-foreground/40 hover:text-foreground/70 active:cursor-grabbing active:text-foreground disabled:opacity-30"
            {...dragHandleProps}
          >
